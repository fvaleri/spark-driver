...
public class EMessageStats {
    public static void main(String[] args) {
        ...
        spark.read().format("csv").option("sep", ",").option("inferSchema", "true").option("header", "true")
                .load(EMessageStats.class.getResource("/messaggio.csv").getPath()).createOrReplaceTempView("messaggio");

        spark.read().format("csv").option("sep", ",").option("inferSchema", "true").option("header", "true")
                .load(EMessageStats.class.getResource("/sistema-area.csv").getPath())
                .createOrReplaceTempView("sistema");

        spark.read().format("csv").option("sep", ",").option("inferSchema", "true").option("header", "true")
                .load(EMessageStats.class.getResource("/servizio.csv").getPath()).createOrReplaceTempView("servizio");

        spark.read().format("csv").option("sep", ",").option("inferSchema", "true").option("header", "true")
                .load(EMessageStats.class.getResource("/dettaglio-servizio.csv").getPath())
